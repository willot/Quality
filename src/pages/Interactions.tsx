        ...
        <section className="bg-white-bg flex flex-row justify-center w-full">
            <LayoutWrapper>
                <section
                    ...
                    <p>You know your application. You use it everyday. But, do you really know it? Did you ever try to
                    ...
                    <section className="py-10">
                        ...
                        <p>Did you ever try to mess with the url? Click on the link below or better try to play with the
                            ...
                            sometimes find i applications. The application is properly secure against users that are not
                            logged in but, when you are logged in you can sometimes take actions you shouldn't be able
                            to. This happens when endpoints are not properly secure with the right permissions. Messing
                            with a url is a simple way to try things. You can also use tools like <a
                    ...
                    <section className="pb-10">
                        ...
                        <p>Lot of people use their keyboard to navigate into applications. Using a keyboard can have a
