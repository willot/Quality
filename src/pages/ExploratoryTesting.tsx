                ...
                <section className="bg-white-bg h-full text-black text-justify py-10 px-1">
                    ...
                    <section className="pb-10">
                        ...
                        <p>For me exploratory testing is using the scientific method to gain insight in your application
                            ...
                            hypothesis hold or doesn't. Then you use your results to create a new hypothesis. This is
                            how
                            you "explore" your application/system. if you want to really dig in this subject I recommend
                            "Explore It!" by Elisabeth Hendrickson. Ultimately how can you guarantee that the system
                            works
                            if you didn't test its edges.</p>
                    </section>
                    <section className="pb-10">
                        <h2 className="font-bold">Why is it useful?</h2>
                        <p>If you do not search for bugs how do you find them? Checking that acceptance criteria are
                            mets
                            is not checking for bugs. It is just making sure the work is done as expected. If you do not
                            try
                            to move beyond just checking the acceptance criteria then you are letting your users find
                            the
                            bugs.
                            If you let your users find the bug you risk to broke the trust of your users and they are
                            more
                            likely
                            to use your competitors. Letting the users find the bugs also increase the stress of your
                            team
                            because
                            someone report the bug. The bug go trough triage and get prioritize. Since it is in
                            production
                            it is
                            very likely that someone will be ask to fix it quickly or someone on call will get a
                            message.
                            The
                            engineer is likely to receive incomplete information about the bug. The person will have to
                            try
                            to
                            gather more data to understand what is the bug. In the same time the manager will keep
                            asking
                            where
                            are we with the bug and when will it be fixed? Then the bug get fixed and get pushed. It
                            distracted a lot of people from their work, added a lot of stress and was terribly
                            inefficient.
                            Lets imagine the happy path. A QA or anybody in the team do some exploratory testing on the
                            stage environment and found an issue. A detailed ticket get created and the product manager
                            decide to prioritize it or not. Then the ticket get added to the engineer queue. The next
                            ...
                            be
                            fixed, no engineer complaining that they don't have information to fix the bug. No
                            disturbance
                            in the normal process</p>
                    </section>
                    <section className="pb-10">
                        <h2 className="font-bold">What does exploratory testing add?</h2>
                        <p>For me exploratory testing is putting yourself in the user shoes. You become a user advocate.
                            How
                            do I feel as a user. Is that really makes sense. Is this confusing? Can I be in a weird
                            state if
                            I do
                    ...
                    <section>
                        ...
                        <p>You need to have a goal when you do exploratory testing. Otherwise you will just wonder
                            aimlessly
                            and not really accomplish anything. It can be as simple as: "I want to test all the ways to
                            create a
                            user". You may find issues that are not relative to your goal, you should note them and
                            comeback
                            later to it. </p>
                        <h3 className="text-pink font-semibold pt-4">The framework</h3>
                        <p>You need to set a side a time for your exploration. I like to use an hour and half to two
                            hours.
                        ...
                        <p>I really recommend to mob when doing exploratory testing. I find 4 people ideal but it is not
                            an
                            hard set rule. What I like about doing with other people is that you generate more idea
                            about
                            potential
                            problems and you get more eyes looking at the screen. You also have more people with
                            knowledge
                            of
                            the system. This can help you create better hypothesis. You are also more likely to catch
                            things.</p>
                    </section>
                    <section>
