            ...
            <section
                ...
                <section className="pb-10">
                    ...
                    <p>For me exploratory testing is using the scientific method to gain insight in your application
                        ...
                        hypothesis hold or doesn't. Then you use your results to create a new hypothesis. This is how
                        you "explore" your application/system. if you want to really dig in this subject I recommend
                        "Explore It!" by Elisabeth Hendrickson. Ultimately how can you guarantee that the system works
                ...
                <section className="pb-10">
                    ...
                    <p>If you do not search for bugs how do you find them? Checking that acceptance criteria are mets
                        ...
                        to move beyond just checking the acceptance criteria then you are letting your users find the
                        bugs.
                        ...
                        distracted a lot of people from their work, added a lot of stress and was terribly inefficient.
                        ...
                        information needed to fix the bug and life go one. No pages, no manager asking when it will be
                        fixed, no engineer complaining that they don't have information to fix the bug. No disturbance
                ...
                <section className="pb-10">
                    ...
                    <p>For me exploratory testing is putting yourself in the user shoes. You become a user advocate. How
                        do I feel as a user. Is that really makes sense. Is this confusing? Can I be in a weird state if
                        I do
                ...
                <section>
                    ...
                    <p>You need to set a side a time for your exploration. I like to use an hour and half to two hours.
                        More it become hard to stay focus and less you feel like you just scratch the surface. I also
                        like to
                    ...
                    <p>I really recommend to mob when doing exploratory testing. I find 4 people ideal but it is not an
                        ...
                        of
                        the system. This can help you create better hypothesis. You are also more likely to catch things.</p>
                </section>
                <section>
