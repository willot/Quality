        ...
        <div className="bg-blue flex flex-row justify-center w-full">
            <section
                ...
                <section className="pb-10">
                    ...
                    and find potential problems. You make an hypothesis. You gather data and you assess if your hypothesis
                    hold or doesn't. Then you use your result to create a new hypothesis. This is how you "explore" your
                    application/system. if you want to really dig in this subject I recommend "Explore It!" by Elisabeth
                    Hendrickson. Ultimately how can you guarantee that the system works if you didn't test its edges.</p>
                </section>
                <section className="pb-10">
                    ...
                    to move behind just checking the acceptance criteria then you are letting your users find the bugs.
                    If you let your users find the bug you risk to broke the trust of your users and they are more likely
                    to use your competitors. Letting the users find the bugs also increase the stress of your team because
                    someone report the bug. The bug go trough triage and get prioritize. Since it is in production it is
                    very likely that someone will be ask to fix it quickly or someone on call will get a message. The
                    engineer is likely to receive incomplete information about the bug. The person will have to try to
                    gather more data to understand what is the bug. In the same time the manager will keep asking where
                    are we with the bug and when it will be fixed. Then the bug get fixed and get pushed. It distracted
                    a lot of people from their work, added a lot of stress and was terribly inefficient. Lets imagine the
                    happy path. A QA do some exploratory testing on the stage environment and found an issue. A detailed
                    ticket get created and the product manager decide to prioritize it or not. Then the ticket get added
                    to the engineer queue. The next engineer to be done pick it up with all the information he needs and
                    life go one. No pages, no manager asking when it will be fixed, no engineer complaining that they
                ...
                <section className="pb-10">
                    ...
                    do I feel as a user. Is that really make sense. Is this confusing? Can I be in a weird state if I do
                    some action in a different order than expected? What can a user do that we didn't think was possible
                ...
                <section>
                    ...
                    and not really accomplish anything. It can be as simple as: "I want to test all the way to create a
                    ...
                    More it become hard to stay focus and less you feel like yiu just scratch the surface. I also like to
                    ...
                    hard set rule. What I like about doing with other people is that you generate more idea about potential
                    problems and you get more eyes looking at the screen. You also have more people with knowledge of
