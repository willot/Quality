    ...
    return (
        <section className="bg-blue flex flex-row justify-center w-full">
            <section
                ...
                <p>Weird bugs are often caused by action happening at time where they should not. They are usually the
                    ...
                    interfere with your current process. An example of this kind of bug happened with my Amazon echo. I
                    asked to play music (which default to amazon music) and then instantly asked to play music on
                    spotify. The result was a
                    mash up of 2 songs playing at the same time... When I said "stop", only spotify stopped. I tried to
                    make it stop amazon music but it didn't work. I had to unplug it. My guess is that spotify got open
                    before the amazon music app launch putting the system in a weird state were two applications were
                ...
                <section>
                    <p className="pt-4">Let's take the example of a real library. A user enter the building. Everybody
                        ...
                        computer it will tell you that the book is available and should be on the shelve. Now the user
                        go to the front desk and officially ask to borrow the book. To do this the user has to show who
                    ...
                    <section className="pt-4">
                        <p>If this process was happening in an application instead of the physical world. The action of
                            ...
                            and placing it in a 'Cart'. The user would then be able to check out the book when finished
                            to
                            selecting all the books desired. If I was a tester, the transition state between available
                            and checked out
                ...
                <section className="pt-4">
                    <p>These kind of tests are hard to automatize. You can write an end to end test for the process of
                        ...
                        also the most likely tests to sometime fail for unseen reasons. This type of tests are usually
                        ...
                        This is where the exploratory testing again can be extremely valuable, and help find this very
                        hard to
