        ...
        <section className="bg-blue flex flex-row justify-center w-full">
            <section
                ...
                <p>Object is maybe more an engineer term to describe something that can be created, updated, or
                    ...
                    application. These objects most of the time are connected/interact with each other. A user will have
                ...
                <section className="py-10">
                    ...
                    <p className="pb-2">The first thing is that you want to identify these objects. As stated
                        earlier
                        they are entities on which you can take actions. A lot of things can happen when you create an
                        object. Are all the fields required? Can you put empty spaces? can you use weird characters
                        "Ω√"?
                        Is there a limit in the number of characters? The problem of string being too long is a pretty
                        common one. Database have limits for the number of characters in a field but the front end
                        will
                        not always enforce it. Therefore the data is send to the back end and it crashes and send back
                        an
                        error... </p>
                            ...
                            <>
                                ...
                                <section className="pt-2">
                                    ...
                                    <p className="pt-2">If you play around you can notice a few things. There are no
                                        ...
                                        cases.
                                        One that I often run into is middle name. If you complete immigration paperwork
                                    ...
                                    <p>Often no error is display to
                                        ...
                                        or if there is an error no explanation is given to remedy it. So it is important
                                        for the front end to be aware to the limitation of the back end to protect the
                                ...
                                <section className="pt-4">
                                    ...
                                    <p className="pb-4 text-green font-semibold">Now update the information you enter
                                        earlier.</p>
                                ...
                                <p className="pt-4">If you are critic you could say that we don't need exploratory
                                    ...
                                    the engineer that created the form originally may not be the same one that add the
                                    apartment field. Context get lost all the
                                    time and tests are very useful to document functionality. Engineers will miss things
                                    because that is what human
                                    do. When you build something you can't think about all the things that go wrong. But
                                    what you can do is writing new tests when a bugs are reported to ensure that in the
                                    future this bug doesn't happen again. For example someone found the bug that white
                                    space should be trim when submitting data. You can easily write a unit test for it
                                    an move on.</p>
                            </>
                        )}
