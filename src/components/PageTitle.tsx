...
export const PageTitle = ({pageButtonFlow, firstButton=true, widthForBigScreen = "2xl:w-5/12"}:PageTitleProps) => {
    return (
        <section className={`px-4 text-left w-full py-28 md:w-10/12 lg:w-9/12 xl:w7/12 ${widthForBigScreen}`}>
